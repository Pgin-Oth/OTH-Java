...
public class ServerREST {
    ...
    public static void main(String[] args) throws IllegalArgumentException, IOException, URISyntaxException {
        ...
        // In den OTH-CIP-Pools bitte auf 172.*.*.* setzen
        // im OTH-WLAN bitte entsprechend auf 10.*.*.*
        // im privaten WLAN koennen Sie folgende Zeile wahrscheinlich auskommentieren
